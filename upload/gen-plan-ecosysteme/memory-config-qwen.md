# 🧠 Configuration Mémoire — qwen (Développement)
...
## 📋 Instructions pour qwen

Copie le texte ci-dessous et colle-le dans qwen pour activer la mémoire permanente :

---

### TEXTE À COPIER DANS QWEN :
...
1. Va sur https://chat.qwen.ai/
2. Connecte-toi à ton compte
3. Va dans **Settings → Personalization → Memory**
4. Active la mémoire si ce n'est pas déjà fait
5. Copie le texte ci-dessus (entre les balises ```)
6. Colle-le dans le chat
7. qwen répondra : "Mémoire configurée pour François..."
...
- Dis "gen-plan:" → qwen doit appliquer les 11 étapes
- Dis "<py script.py>" → qwen doit créer un script Python
- Dis "programme C++" → qwen doit utiliser l'agent coding-agent

---

**Configuration créée le 2026-06-21**