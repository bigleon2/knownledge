#!/bin/bash
# Configuration mémoire pour z.ai (ingénieur système)
# Ce script génère le texte à copier-coller dans z.ai pour activer la mémoire permanente

echo "🧠 Configuration Mémoire pour z.ai"
echo "===================================="
echo ""
echo "📋 Instructions :"
echo "1. Va sur https://chat.z.ai/"
echo "2. Connecte-toi"
echo "3. Va dans Settings → Memory (记忆)"
echo "4. Active la mémoire si ce n'est pas déjà fait"
echo "5. Copie le texte ci-dessous et colle-le dans le chat"
echo ""
echo "===================================="
echo "📝 TEXTE À COPIER DANS Z.AI :"
echo "===================================="
echo ""
cat << 'EOF'
...
AGENTS SPÉCIALISÉS DJ/SYSTÈME :
- tsi-expert : Expert fichiers TSI (TRAKTOR mappings XML MIDI)
- kontrol-s4-expert : Expert KONTROL S4 MK2 hardware (drivers, firmware, MIDI, Haptic Drive)
- python-executor : Exécution scripts Python (<py script.py>)
- pdf-expert : Génération/extraction/manipulation PDF
- image-analyst : Analyse images (VLM, OCR, computer vision)
- auto-tagger : Tagging audio automatique (BPM, clé, genre, bibliothèque DJ)
...
Skills prioritaires pour mon usage :
- fullstack-dev (Next.js 16, TypeScript, Tailwind)
- pdf, pdf-llm (génération/extraction PDF)
- VLM, image-understand (analyse images)
...
7. Utiliser les 12 agents spécialisés quand pertinent
